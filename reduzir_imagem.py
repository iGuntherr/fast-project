...
if __name__ == "__main__":
    input_dir = input("Digite o diretório das imagens: ")
    input_out = input("Digite o diretório para armazenamento das imagens: ")

    reduzir_tamanho_imagens(input_dir, input_out)